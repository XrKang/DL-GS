...
def loadCam(args, id, cam_info, resolution_scale):
    ...
    if cam_info.tele_image:
        resolution_tele = resolution[0]//2, resolution[1]//2
        # print("Tele image resolution: ", resolution_tele)
        tele_image = PILtoTorch(cam_info.tele_image, resolution_tele)
    else:
        tele_image = None
    ...
    return Camera(colmap_id=cam_info.uid, R=cam_info.R, T=cam_info.T, 
                  FoVx=cam_info.FovX, FoVy=cam_info.FovY, image=gt_image, tele_image=tele_image, gt_alpha_mask=loaded_mask,
